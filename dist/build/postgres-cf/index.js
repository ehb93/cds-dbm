...
const cds_foss_1 = __importDefault(require("@sap/cds-foss"));
const fs = (0, cds_foss_1.default)('fs-extra');
...
class PostgresCfModuleBuilder extends BuildTaskHandlerInternal {
    ...
    async _writeManifestYml() {
        ...
        if ((await fs.pathExists(path_1.default.join(this.task.src, FILE_NAME_MANIFEST_YML))) ||
            (await fs.pathExists(path_1.default.join(this.task.src, 'manifest.yml')))) {
            if (DEBUG) {
